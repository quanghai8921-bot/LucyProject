...
import com.lucy.backend.content.mentor.dto.CreateRoomQuizOptionRequest;
import com.lucy.backend.content.mentor.dto.CreateRoomQuizQuestionRequest;
import com.lucy.backend.content.mentor.dto.CreateRoomQuizRequest;
...
public class RoomQuizService {
    ...
    public List<com.lucy.backend.content.mentor.dto.RoomQuizAttemptDto> getLearnerAssignedQuizzes(String userId) {
        return roomQuizAttemptRepository.findByUserId(userId).stream()
                ...
                .map(a -> {
                    ...
                    return new com.lucy.backend.content.mentor.dto.RoomQuizAttemptDto(
                            a.getAttemptId(),
                            a.getQuizId(),
    ...
    public com.lucy.backend.content.learner.dto.SubmitQuizResponse submitQuiz(String attemptId, com.lucy.backend.content.learner.dto.SubmitQuizRequest request) {
        RoomQuizAttempt attempt = roomQuizAttemptRepository.findById(attemptId)
                .orElseThrow(() -> new IllegalArgumentException("Attempt not found: " + attemptId));
        ...
        return new com.lucy.backend.content.learner.dto.SubmitQuizResponse(scorePercent, isPassed);
    }
}
