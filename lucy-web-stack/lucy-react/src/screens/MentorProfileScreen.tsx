...
export const MentorProfileScreen: React.FC = () => {
  ...
  // Determine back navigation route based on role
  ...
  const isCreator = dbRole.includes('creator') || dbRole.includes('r004') || localRole.includes('creator') || localRole.includes('r004');
  const backRoute = isCreator ? '/creator' : '/mentor';
