...
import com.lucy.lms.mentor.repository.RoomQuizAttemptAnswerRepository;
...
public class LearnerRoomService {
    ...
    public AttendanceCheck askAttendance(String roomId, String userId, String levelId, String subLevelId) {
        ...
        LearningSession session = learningSessionRepository
                ...
                .orElseGet(() -> new LearningSession(UUID.randomUUID().toString(), userId, roomId, levelId, subLevelId));
    ...
    public QuizSubmitResultDto submitQuiz(String quizId, QuizSubmitRequest request) {
        ...
        Map<String, QuizSubmitRequest.Answer> answerByQuestionId = (request.getAnswers() == null ? List.<QuizSubmitRequest.Answer>of() : request.getAnswers())
                .stream()
        ...
        BigDecimal passingScore = quiz.getPassingScorePercent() == null ? BigDecimal.valueOf(80) : quiz.getPassingScorePercent();
    ...
    private void markProgressPassed(QuizSubmitRequest request) {
        ...
        UserProgress progress = userProgressRepository
                .findFirstByUserIdAndLanguageIdAndLevelId(request.getUserId(), request.getLanguageId(), request.getLevelId())
